...
param wf_d365_omnisync_accounts_delete_name string = 'wf-d365-omnisyncinc-accounts-delete-${suffix}'
...
resource wf_d365_omnisync_accounts_delete 'Microsoft.Logic/workflows@2019-05-01' = {
  name: wf_d365_omnisync_accounts_delete_name
  location: location
  properties: {
    state: 'Enabled'
    integrationAccount: {
