...
param wf_d365_omnisync_products_insert_name string = 'wf-d365-omnisyncinc-products-insert-${suffix}'
...
resource wf_d365_omnisync_products_insert 'Microsoft.Logic/workflows@2019-05-01' = {
  name: wf_d365_omnisync_products_insert_name
  location: location
  properties: {
    state: 'Enabled'
    integrationAccount: {
