...
param wf_sffabricomnisyncretailstoreinsert_name string = 'wf-sffabricomnisyncretailstoreinsert-${suffix}'
param ia_omnisync_id string=''
param connections_eventhubs_id string=''
param connections_salesforce_id string=''

resource wf_sffabricomnisyncretailstoreinsert 'Microsoft.Logic/workflows@2019-05-01' = {
  name: wf_sffabricomnisyncretailstoreinsert_name
  location: location
  properties: {
    state: 'Enabled'
    integrationAccount: {
