...
param wf_d365_omnisync_orders_update_name string = 'wf-d365-omnisyncinc-orders-update-${suffix}'
...
resource wf_d365_omnisync_orders_update 'Microsoft.Logic/workflows@2019-05-01' = {
  name: wf_d365_omnisync_orders_update_name
  location: location
  properties: {
    state: 'Enabled'
    integrationAccount: {
