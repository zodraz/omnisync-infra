...
param wf_sf_fabric_omnisync_retailstore_update_name string = 'wf-sf-fabric-omnisync-retailstore-update-${suffix}'
param ia_omnisync_id string=''
param connections_eventhubs_id string=''
param connections_salesforce_id string=''

resource wf_sf_fabric_omnisync_retailstore_update 'Microsoft.Logic/workflows@2019-05-01' = {
  name: wf_sf_fabric_omnisync_retailstore_update_name
  location: location
  properties: {
    state: 'Enabled'
    integrationAccount: {
