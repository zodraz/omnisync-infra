        ...
        Check_Integration_user: {
          ...
          runAfter: {
            ...
            actions: {
              ...
              Check_if_Mapping_Product_row_exists_: {
                actions: {
                  Delete_Product: {
                    runAfter: {
                      Delay: [
                    ...
                    inputs: {
                      ...
                      method: 'delete'
                      path: '/datasets/default/tables/@{encodeURIComponent(encodeURIComponent(\'Product2\'))}/items/@{encodeURIComponent(encodeURIComponent(body(\'Get_Mapped_SalesForceId\')?[\'ResultSets\'][\'Table1\'][0][\'SalesForceId\']))}'
                    }
                  }
                  Delay: {
                    type: 'Wait'
                ...
                runAfter: {
                  ...
                  actions: {
                    Response_Account_not_found: {
                      ...
                      inputs: {
                        statusCode: 404
                        body: 'Product with D365Id @{triggerBody()?[\'name\']}  to delete not found on Dynamics365'
                      }
                    }
                  }
                }
